...
public class RelationalDescriptorsBuilder implements IRelationalDescriptorsBuilder {
	...
	public RelationalDescriptorsBuilder(ICopycatSignal signal) 
		...
		do {
			INewGenOfDescriptorsBuilder newGenOfDescriptorsBuilder = 
					new NewGenOfDescriptorsBuilder(previousGenerationNumber, this.signal, 
