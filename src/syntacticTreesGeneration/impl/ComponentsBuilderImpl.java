...
public class ComponentsBuilderImpl implements IComponentsBuilder {

	protected List<Frame> listOfFrames;
	protected boolean listOfFramesCoverTheFullString = false;
	
	public ComponentsBuilderImpl(List<Frame> listOfFrames) {
		this.listOfFrames = listOfFrames;
	}
	
	public ComponentsBuilderImpl(List<Frame> listOfFrames, boolean listOfFramesCoverTheFullString) 
