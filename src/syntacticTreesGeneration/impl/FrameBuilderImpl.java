...
public class FrameBuilderImpl implements IFrameBuilder {

	private final List<Frame> listOfFrames;
	private final IRelationDataContainer relationDataContainer;
	
	public FrameBuilderImpl(List<Frame> listOfFrames, IRelationDataContainer relationDataContainer) {
	...
	public Frame getFrame() throws SynTreeGenerationException, CloneNotSupportedException {
		...
		Relations relations;
		IRelationsBuilder relationsBuilder = new RelationsBuilderImpl(relationDataContainer, listOfFrames);
