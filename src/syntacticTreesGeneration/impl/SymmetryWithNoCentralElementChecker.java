...
public class SymmetryWithNoCentralElementChecker implements ISymmetryWithNoCentralElementChecker {
	...
	public SymmetryWithNoCentralElementChecker(boolean wholeStringIsDescribed, String dimension, List<String> values, 
