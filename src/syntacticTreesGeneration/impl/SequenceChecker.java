...
public class SequenceChecker implements ISequenceChecker {
	...
	public SequenceChecker(boolean wholeStringIsDescribed, String dimension, List<String> values, 
	...
	public ISequenceRelationalData getSequenceRelationalData() throws SynTreeGenerationException {
		...
		ISequenceRelationalData sequenceRelationalData = 
				new SequenceRelationalData(this.dimension, enumerationValue, commonDifferenceValue);
