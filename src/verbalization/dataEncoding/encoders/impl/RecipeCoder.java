...
public class RecipeCoder implements IRecipeCoder {

	private IRecipeCodeGetter recipeCodeGetter;
	
	public RecipeCoder(List<String> listOfUnfactorizedFrameProperties) throws VerbalizationException {
	...
	private List<IInstructionCodeGetter> setListOfInstructionsRecursively(List<String> frameListOfProperties) 
		...
		IInstructionCoder instructionCoder = new InstructionCoder(nbOfComponents, relationXPropertyList); 
