...
public class TransformationCoder implements ITransformationCoder{
	...
	public TransformationCoder(String nbOfComponents, List<String> relationProperties) throws VerbalizationException {
