...
public class OrderedSetBuilderImpl implements IOrderedSetBuilder {
	...
	public OrderedSetBuilderImpl(List<ISyntacticTree> listOfSynTreeElement, String verbalDescription) 
	...
	public OrderedSetBuilderImpl(List<ISyntacticTree> listOfSynTreeElement) throws OrderedSetsGenerationException {
		setListOfPropertiesToIndexMap(listOfSynTreeElement);
		List<IOrderedSet> listOfSubMaximalPowerSetElements = new ArrayList<IOrderedSet>();
		for (ISyntacticTree synTreeGrammElement : listOfSynTreeElement) {
			IOrderedSet subMaximalPowerSetElement = synTreeGrammElement.upgradeAsTheElementOfAnOrderedSet(listOfPropertiesToIndex);
	...
	public OrderedSetBuilderImpl(IStartElementST startElement) 
