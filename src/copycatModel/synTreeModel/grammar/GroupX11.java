...
public class GroupX11 extends HowManyGroups implements Cloneable {

	private static final String descriptorName = "groupX11";
	...
	public GroupX11(boolean codingDescriptor, Group group1, Group group2, Group group3, Group group4, Group group5,
			Group group6, Group group7, Group group8, Group group9, Group group10, Group group11) 
	...
	@Override
	protected GroupX11 clone() throws CloneNotSupportedException {
		GroupX11 cloneGroupX11;
		...
		try {
			cloneGroupX11 = new GroupX11(isCodingByDecomposition, cloneableGroup1, cloneableGroup2, 
					cloneableGroup3, cloneableGroup4, cloneableGroup5, cloneableGroup6, cloneableGroup7, 
					cloneableGroup8, cloneableGroup9, cloneableGroup10, cloneableGroup11);
		} catch (SynTreeGenerationException e) {
			throw new CloneNotSupportedException("GroupX11 : error error in clone() method.");
		}
		return cloneGroupX11;
	}	
