...
import verbalization.dataEncoding.encoders.impl.DescriptionCoder;
...
public class DescriptionCoderTest {
	...
	public void whenParameterIsThisListOfPropertiesThenExpectedNumberOfRecipesIsReturned() 
		...
		try {
			IListOfDescriptorsBuilder listOfDescriptorsBuilder = new ListOfDescriptorsBuilder("abcd", "fromLeftToRight");
			...
			for (CharString descriptor : listOfDescriptors) {
				...
				IDescriptionCoder descriptionCoder = new DescriptionCoder(descriptor);
