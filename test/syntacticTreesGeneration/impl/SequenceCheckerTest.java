...
import syntacticTreesGeneration.impl.SequenceChecker;
...
public class SequenceCheckerTest {
	...
	public void ifValuesArentTheSameSizeThenNoSequenceFound() throws SynTreeGenerationException {
		enumerationChecker = new EnumerationChecker(wholeStringIsDescribed_true, dimension, listOfValuesOfDifferentSizes);
	...
	public void ifNoCommonDifferenceValueThenNoSequenceFound() throws SynTreeGenerationException {
		enumerationChecker = new EnumerationChecker(wholeStringIsDescribed_false, dimension, listOfSize1ValuesWithNoCommonDiff);
		IEnumerationRelationalData enumerationRelationalData = enumerationChecker.getEnumerationRelationalData();
		sequenceChecker = 
				new SequenceChecker(
	...
	public void ifNoCommonPatternBtw2ndDegreeValuesThenNoSequenceFound() throws SynTreeGenerationException {
		enumerationChecker = 
				new EnumerationChecker(wholeStringIsDescribed_true, dimension, listOf2ndDegreeValuesWithNoCommonPatternButCommonDifference);
		IEnumerationRelationalData enumerationRelationalData = enumerationChecker.getEnumerationRelationalData();
		sequenceChecker = 
				new SequenceChecker(
	...
	public void ifIncrementIsSuperiorToTheMaxValueInSettingsThenNoSequenceFound() throws SynTreeGenerationException {
		enumerationChecker = 
				new EnumerationChecker(wholeStringIsDescribed_false, dimension, listOfValuesWithIncrementTooBig);
		IEnumerationRelationalData enumerationRelationalData = enumerationChecker.getEnumerationRelationalData();
		sequenceChecker = 
				new SequenceChecker(
	...
	public void ifValuesAreIdenticalThenSequenceIsFound() throws SynTreeGenerationException {
		enumerationChecker = 
				new EnumerationChecker(wholeStringIsDescribed_false, dimension, listOfIdenticalValues);
		IEnumerationRelationalData enumerationRelationalData = enumerationChecker.getEnumerationRelationalData();
		sequenceChecker = 
				new SequenceChecker(wholeStringIsDescribed_false, dimension, listOfIdenticalValues, enumerationRelationalData);
	...
	public void ifCommonDifferenceBtwSize1ValuesThenSequenceFound() throws SynTreeGenerationException {
		enumerationChecker = 
				new EnumerationChecker(wholeStringIsDescribed_false, dimension, listOfSize1ValuesWithCommonDiff);
		IEnumerationRelationalData enumerationRelationalData = enumerationChecker.getEnumerationRelationalData();
		sequenceChecker = 
				new SequenceChecker(wholeStringIsDescribed_false, dimension,
