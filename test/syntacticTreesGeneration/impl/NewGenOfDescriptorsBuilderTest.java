...
import syntacticTreesGeneration.impl.NewGenOfDescriptorsBuilder;
import syntacticTreesGeneration.impl.SignalBuilder;

public class NewGenOfDescriptorsBuilderTest {
	...
	public void whenStringLengthAndSettingsAllowItThenReturnsNextGenOfDescriptors() 
		...
		ISignalBuilder signalBuilder = new SignalBuilder("abcdefghij", "fromLeftToRight");
		...
		INewGenOfDescriptorsBuilder newGenOfDescriptorsBuilder = 
				new NewGenOfDescriptorsBuilder(1, (ICopycatSignal) signal, listOfFrames);
		...
		System.out.println(""); */
		newGenOfDescriptorsBuilder = new NewGenOfDescriptorsBuilder(2, (ICopycatSignal) signal, factorizableGen2Descriptors);
		...
		System.out.println("");	*/
		newGenOfDescriptorsBuilder = new NewGenOfDescriptorsBuilder(3, (ICopycatSignal) signal, factorizableGen3Descriptors);
